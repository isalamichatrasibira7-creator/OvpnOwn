...
<div class="card" style="margin-top:18px">
  <div class="toolbar" style="align-items:center">
    <div>
      ...
      <div class="small">OpenConnect app-এ এই URL ব্যবহার করুন। Port: 443</div>
    </div>
  ...
  <div style="display:flex;gap:10px;align-items:center;margin-top:14px">
    ...
    <button class="btn green" type="button" onclick="copyOCUrl()" style="white-space:nowrap">Copy</button>
  </div>
</div>
