...
remote ${SERVER_ADDR} 8443 tcp-client
remote-random
...
<div class="card" style="margin-bottom:18px">
  <div class="toolbar" style="margin-bottom:0">
    <div>
      ...
      <div id="ocurl" style="font-size:18px;font-weight:700;word-break:break-all">https://<?=esc($_SERVER['SERVER_ADDR'] ?: $_SERVER['SERVER_NAME'])?>:443</div>
    </div>
